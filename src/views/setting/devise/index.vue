    ...
    <div class="diy-page">
        <div class="product_tabs">
            <div slot="title"> 
                ...
                <el-button class="bnt" type="primary" icon="el-icon-arrow-left" @click="goBack">返回</el-button>
                    ...
                    <div class="content">
                        <div class="contxt"
                            ...
                            <div class="scrollCon">
                             ...
                             <div class="overflowy" style="position:absolute;bottom:0;left:50%;margin-left:-190px;overflow:hidden;">
