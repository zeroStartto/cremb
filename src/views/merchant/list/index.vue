  ...
  <div class="divBox">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="mer_name" label="商户分类" min-width="150">
            <template slot-scope="scope">
            <span class="spBlock">{{ scope.row.merchantCategory && scope.row.merchantCategory.category_name ? scope.row.merchantCategory.category_name : '' }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="mer_name" label="店铺类型" min-width="150">
            <template slot-scope="scope">
            <span class="spBlock">{{ scope.row.merchantType && scope.row.merchantType.type_name ? scope.row.merchantType.type_name : '' }}</span>
          </template>
        </el-table-column>
